...
public class Admin extends javax.swing.JInternalFrame {
   ...
   private void cargarPanel(JPanel panel) {
    ...
    private void initComponents() {
        ...
        EscritorioAdmin.setBackground(new java.awt.Color(255, 204, 153));
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/IMG/tienda_1.png"))); // NOI18N
        ...
        fecha.setFont(new java.awt.Font("Impact", 0, 14)); // NOI18N
    ...
    private void jBGPedidosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBGPedidosActionPerformed
        if (connection == null) {
            JOptionPane.showMessageDialog(null, "No se pudo establecer conexión con la base de datos.");
            return;
        }cargarPanel(new GPedidos1(connection ));
